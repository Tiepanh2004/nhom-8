...
if (
    ...
    $sql = "UPDATE `bai_tap` 
                SET `noi_dung`='$noiDung',`dap_an_1`='$dapAn1',`dap_an_2`='$dapAn2',`dap_an_3`='$dapAn3',`dap_an_4`='$dapAn4',`id_khoa_hoc`='$khoaHoc',`dap_an_dung`='$dapAnDung' WHERE `id` = $id";
    // echo $sql;
...
<body>
    <div class="form">
        <h1 style="text-align: center;">Cập nhật bài luyện tập</h1>
        <p style="text-align: center; font-style: italic">
            Bạn đang cập nhật bài luyện tập số <?php echo $id; ?>
        </p>
        <form action="index.php?page_layout=capnhatbailuyentap&id=<?php echo $id ?>" method="post">
            <div class="box1">
                <div>
                    <p>Nội dung</p>
